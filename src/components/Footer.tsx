    ...
    <footer className="relative z-10 border-t border-stone-300 bg-stone-200/60 text-stone-600">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between sm:items-center">
          <p className="text-[10px] sm:text-xs text-stone-500 sm:flex-1 text-center sm:text-left">
            © Prof. h.c. Univ.-Doz. Dr. Günther Neumayr
          </p>

          <nav className="flex flex-col items-center gap-2 sm:flex-row sm:items-center sm:gap-6 sm:flex-1 sm:justify-end text-sm" aria-label="Rechtliches">
            <Link
              href="/impressum"
